        ...
        <div className="flex justify-center">
          <div className="max-w-lg w-full bg-white dark:bg-gray-800 rounded-lg p-8">
            <form className="flex flex-col sm:flex-row justify-center gap-2 items-center">
              <Input type="email" className="bg-gray-100 dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-lg py-3 px-4  sm:mr-4 w-full sm:w-72" placeholder="Entrez votre adresse email" />
